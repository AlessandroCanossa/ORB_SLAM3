...
namespace ORB_SLAM3
{
                                            ...
                                            Sophus::SE3f &T21, vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated)
    {
        ...
        else // if(pF_HF>0.6)
        {
            ...
            return ReconstructF(vbMatchesInliersF, F, mK, T21, vP3D, vbTriangulated, minParallax, 10);
        }
    }
                                             ...
                                             Sophus::SE3f &T21, vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated, float minParallax, int minTriangulated)
    {
        ...
        {
            std::cout << "no clear winner or not enough triangulated points\n";
        ...
        // std::cout << "max good has not enough parallax\n";
        return false;
    }
