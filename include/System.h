...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        // TrackMonocular with keypoints and descriptors
        Sophus::SE3f TrackKpMonocular(const std::vector<cv::KeyPoint> &kpts, const cv::Mat &desc, const double &timestamp, const vector<IMU::Point> &vImuMeas = vector<IMU::Point>(), string filename = "");
