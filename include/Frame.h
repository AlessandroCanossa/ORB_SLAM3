...
#define FRAME_GRID_COLS 64
    ...
    public:
        ...
        // Contructor with keypoints and descriptors
        Frame(const std::vector<cv::KeyPoint> &keys, const cv::Mat &descriptors, const double &timeStamp, ORBextractor *extractor, ORBVocabulary *voc, GeometricCamera *pCamera, cv::Mat &distCoef, const float &bf, const float &thDepth, Frame *pPrevF = static_cast<Frame *>(NULL), const IMU::Calib &ImuCalib = IMU::Calib());
